...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(io.github.jhipster.application.domain.Devices.class.getName(), jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.Transactions.class.getName(), jcacheConfiguration);
